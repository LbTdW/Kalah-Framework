...
import info.kwarc.teaching.AI.Kalah.Agents.{HumanPlayer, RandomPlayer, TimeOut, DummyAgent}
...
object Test {
  def main(args: Array[String]): Unit = {
    ...
    new Game(new DummyAgent(),new RandomPlayer("Hurtz"),int + Terminal)(12,12).play
  }
}
